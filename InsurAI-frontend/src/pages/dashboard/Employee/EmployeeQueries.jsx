                  ...
                  <div className="list-group list-group-flush">
                    {agentsAvailability.map((agentAvailability) => (
                      <div
                        ...
                        className={`list-group-item px-3 py-3 ${!agentAvailability.available ? 'opacity-75' : ''}`}
                      >
                        <div className="d-flex align-items-center mb-2">
                          <div
                            className={`rounded-circle me-3 ${agentAvailability.available ? 'bg-success' : 'bg-secondary'}`}
                        ...
                        {/* Agent Details */}
                        <div className="small text-gray-600 ms-4">
                        ...
                        {!agentAvailability.available && (
                          <div className="alert alert-warning p-2 mt-2 mb-0 small ms-4">
