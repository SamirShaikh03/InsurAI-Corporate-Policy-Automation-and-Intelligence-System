...
const renderStatsCards = () => (
  <div className="row mb-4">
    {[
      ...
      <div key={idx} className="col-xl-4 col-md-6 mb-4">
        <div className={`stat-card card border-0 h-100 ${stat.color}`}>
        ...
        <div className="d-flex justify-content-between align-items-center flex-wrap gap-3">
          ...
          <div className="chart-toggle-group">
            {[
              ...
              <button
                key={chart.key}
                className={`chart-toggle-btn ${activeChart === chart.key ? "active" : ""}`}
      ...
      <div className="card-body">
        <div className="row align-items-center">
          <div className="col-md-8">
            ...
            <small>Download detailed performance data in various formats</small>
          </div>
  ...
  return (
    <div className="agent-reports mb-4">
      <div className="reports-header">
        <h3>Agent Performance Reports</h3>
        <p>Comprehensive analytics and performance metrics with advanced visualizations</p>
      </div>
