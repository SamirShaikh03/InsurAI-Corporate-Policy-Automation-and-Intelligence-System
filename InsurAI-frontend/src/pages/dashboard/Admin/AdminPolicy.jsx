  ...
  return (
    <div className="admin-policy-wrapper">
      ...
      <div className="ap-page-header">
        <div>
          <h3 className="ap-page-title">
            <span className="ap-page-title-icon">
      ...
      <div className="ap-stats-grid">
        <div className="ap-stat-card primary">
          <div className="ap-stat-header">
            <div>
              <div className="ap-stat-label">Total Policies</div>
        ...
        <div className="ap-stat-card success">
          <div className="ap-stat-header">
            <div>
              <div className="ap-stat-label">Active Policies</div>
        ...
        <div className="ap-stat-card secondary">
          <div className="ap-stat-header">
            <div>
              <div className="ap-stat-label">Health Policies</div>
              <div className="ap-stat-value">{stats.health}</div>
            </div>
            <div className="ap-stat-icon">
        ...
        <div className="ap-stat-card accent">
          <div className="ap-stat-header">
            <div>
              <div className="ap-stat-label">Life Policies</div>
              <div className="ap-stat-value">{stats.life}</div>
            </div>
            <div className="ap-stat-icon">
      ...
      <div className="ap-form-card">
        ...
        <div className="ap-form-body">
          {message && (
            <div className={`ap-alert ${message.includes('✅') ? 'ap-alert-success' : 'ap-alert-danger'}`}>
              {message}
              <button type="button" className="ap-alert-close" onClick={() => setMessage('')}>×</button>
            </div>
          )}
          ...
          <form onSubmit={handleSubmit}>
            <div className="ap-form-row">
              <div>
                <div className="ap-form-group">
                  <label className="form-label fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Policy Number *</label>
                  <input 
                    type="text" 
                ...
                <div className="mb-3">
                  <label className="form-label fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Policy Name *</label>
                  <input 
                    type="text" 
                    className="form-control" 
                    name="policyName" 
                ...
                <div className="mb-3">
                  <label className="form-label fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Policy Type *</label>
                ...
                <div className="mb-3">
                  <label className="form-label fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Provider Name *</label>
                  <input 
                    type="text" 
                    className="form-control" 
                    name="providerName" 
              ...
              <div className="col-md-6">
                <div className="mb-3">
                  <label className="form-label fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Coverage Amount (₹) *</label>
                  <input 
                    type="number" 
                    className="form-control" 
                    name="coverageAmount" 
                ...
                <div className="mb-3">
                  <label className="form-label fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Monthly Premium (₹) *</label>
                  <input 
                    type="number" 
                    className="form-control" 
                    name="monthlyPremium" 
                ...
                <div className="mb-3">
                  <label className="form-label fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Start Date *</label>
                  <input 
                    type="date" 
                    className="form-control" 
                    name="startDate" 
                ...
                <div className="mb-3">
                  <label className="form-label fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Renewal Date *</label>
                  <input 
                    type="date" 
                    className="form-control" 
                    name="renewalDate" 
            ...
            <div className="row">
              <div className="col-md-6">
                <div className="mb-3">
                  <label className="form-label fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Policy Status</label>
            ...
            <div className="mb-3">
              <label className="form-label fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Policy Description</label>
              <textarea 
                className="form-control" 
                rows="3" 
            ...
            {/* Document Uploads */}
            <div className="mb-4">
              <h6 style={{ color: COLORS.TEXT_DARK }} className="mb-3">
      ...
      <div className="card shadow-sm border-0">
        <div className="card-header bg-white py-3 d-flex justify-content-between align-items-center">
          <h5 className="m-0 font-weight-bold" style={{ color: COLORS.TEXT_DARK }}>
        ...
        <div className="card-body p-0">
          {loading ? (
            ...
            <div className="text-center py-5">
              <i className="bi bi-file-earmark-x display-1 d-block mb-3" style={{ color: `${COLORS.SECONDARY}30` }}></i>
            ...
            <div className="table-responsive">
              <table className="table table-hover mb-0">
                <thead className="bg-light">
                  <tr>
                    <th className="border-0 font-weight-bold" style={{ color: COLORS.TEXT_DARK }}>Policy Details</th>
                    <th className="border-0 font-weight-bold" style={{ color: COLORS.TEXT_DARK }}>Coverage</th>
                    <th className="border-0 font-weight-bold" style={{ color: COLORS.TEXT_DARK }}>Premium</th>
                    <th className="border-0 font-weight-bold" style={{ color: COLORS.TEXT_DARK }}>Status</th>
                    <th className="border-0 font-weight-bold" style={{ color: COLORS.TEXT_DARK }}>Actions</th>
                  </tr>
                </thead>
                <tbody>
                  {currentPolicies.map((policy) => (
                    <tr key={policy.id} className="border-bottom">
                      <td>
                        <div className="d-flex align-items-center">
                          <div 
                            ...
                            style={{
                              backgroundColor: policy.policyType === "Health" ? COLORS.SECONDARY : 
                                             policy.policyType === "Life" ? COLORS.SUCCESS : 
                          ...
                          <div>
                            <div className="fw-semibold" style={{ color: COLORS.TEXT_DARK }}>{policy.policyName}</div>
                      ...
                      <td className="align-middle">
                        <div className="fw-bold" style={{ color: COLORS.TEXT_DARK }}>₹{policy.coverageAmount}</div>
                        <small style={{ color: COLORS.TEXT_MUTED }}>Coverage</small>
                      </td>
                      <td className="align-middle">
                        <div className="fw-bold" style={{ color: COLORS.TEXT_DARK }}>₹{policy.monthlyPremium}</div>
            ...
            <div className="modal-content border-0 shadow-lg">
              ...
              <div className="modal-body overflow-auto" style={{ maxHeight: '70vh' }}>
                <div className="row">
                  <div className="col-md-6">
                    <div className="mb-3">
                      <label className="fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Policy Number</label>
                      <p style={{ color: COLORS.TEXT_DARK }}>{viewPolicy.policyNumber}</p>
                    </div>
                    <div className="mb-3">
                      <label className="fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Policy Type</label>
                      <p style={{ color: COLORS.TEXT_DARK }}>{viewPolicy.policyType}</p>
                    </div>
                    <div className="mb-3">
                      <label className="fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Provider Name</label>
                      <p style={{ color: COLORS.TEXT_DARK }}>{viewPolicy.providerName}</p>
                    </div>
                    <div className="mb-3">
                      <label className="fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Coverage Amount</label>
                      <p style={{ color: COLORS.TEXT_DARK }}>₹{viewPolicy.coverageAmount}</p>
                    </div>
                  </div>
                  <div className="col-md-6">
                    <div className="mb-3">
                      <label className="fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Monthly Premium</label>
                      <p style={{ color: COLORS.TEXT_DARK }}>₹{viewPolicy.monthlyPremium}</p>
                    </div>
                    <div className="mb-3">
                      <label className="fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Start Date</label>
                      <p style={{ color: COLORS.TEXT_DARK }}>{viewPolicy.startDate}</p>
                    </div>
                    <div className="mb-3">
                      <label className="fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Renewal Date</label>
                      <p style={{ color: COLORS.TEXT_DARK }}>{viewPolicy.renewalDate}</p>
                    </div>
                    <div className="mb-3">
                      <label className="fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Status</label>
                      <p>
                ...
                <div className="mb-3">
                  <label className="fw-semibold" style={{ color: COLORS.TEXT_DARK }}>Policy Description</label>
                  <p style={{ color: COLORS.TEXT_DARK }}>{viewPolicy.policyDescription || "No description provided."}</p>
                </div>
