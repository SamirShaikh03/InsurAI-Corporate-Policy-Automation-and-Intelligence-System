...
public class NotificationService {
    ...
    public void sendEnrollmentApprovalEmail(String to, String employeeName, String policyName, java.time.LocalDate effectiveDate) {
        try {
            ...
            String content = "<!DOCTYPE html><html><head><meta charset='UTF-8'>" +
                    ...
                    "<p>Congratulations! Your enrollment for <strong>" + policyName + "</strong> has been approved.</p>" +
                    "<p>Your coverage will be effective from: <strong>" + effectiveDate + "</strong></p>" +
                    "<p>Please login to <strong>InsurAi Employee Dashboard</strong> to view your enrollment details.</p>" +
                    "</div><div class='footer'>This is an automated message. Please do not reply.</div>" +
                    "</body></html>";
    ...
    public void sendReimbursementStatusEmail(String to, String employeeName, Long claimId, String status, Double amount) {
        try {
            ...
            String content = "<!DOCTYPE html><html><head><meta charset='UTF-8'>" +
                    ...
                    "<div class='content'>" +
                    "<p>Dear " + employeeName + ",</p>" +
                    "<p>Your reimbursement for Claim #" + claimId + " has been <strong>" + status + "</strong>.</p>" +
    ...
    public void sendRenewalAlertEmail(String to, String employeeName, String policyName,
        ...
        try {
            ...
            helper.setSubject(urgency + "InsurAi: Policy Renewal Alert - " + policyName);
            ...
            String content = "<!DOCTYPE html><html><head><meta charset='UTF-8'>" +
                    ...
                    ".footer { margin: 20px; font-size: 0.85em; color: gray; }" +
                    "</style></head><body>" +
                    "<div class='header'><h2>Policy Renewal Alert</h2></div>" +
                    "<div class='content'>" +
                    "<p>Dear " + employeeName + ",</p>" +
                    "<p>Your policy <strong>" + policyName + "</strong> will expire in <strong>" + daysRemaining + " days</strong>.</p>" +
    ...
    public void sendPolicyStatusEmail(String to, String employeeName, String policyName, String status) {
        try {
            ...
            helper.setTo(to);
            helper.setSubject("InsurAi: Policy Status Update - " + policyName);
            ...
            String content = "<!DOCTYPE html><html><head><meta charset='UTF-8'>" +
                    ...
                    ".footer { margin: 20px; font-size: 0.85em; color: gray; }" +
                    "</style></head><body>" +
                    "<div class='header'><h2>Policy Status: " + status + "</h2></div>" +
                    "<div class='content'>" +
                    "<p>Dear " + employeeName + ",</p>" +
                    "<p>Your policy <strong>" + policyName + "</strong> is now <strong>" + status + "</strong>.</p>" +
